		...
		function initialiseMap() {
			...
			if (mainDescription.overlays) {
				...
				function addOverlay(overlayType) {
					...
					var kml = new google.maps.KmlLayer(overlay.url + '?v=4', {'preserveViewport': true, 'suppressInfoWindows': true});
					...
					li.find('input').attr({'id': checkboxId}).change(checkboxOnChange).click(checkboxOnChange);
